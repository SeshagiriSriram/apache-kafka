package com.sriram.kafka.serdes;

import com.sriram.kafka.dto.MessageDto;
...
public class KafkaSerDesLiveTest {
    ...
    private static KafkaConsumer<String, MessageDto> createKafkaConsumer() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "com.sriram.kafka.serdes.CustomDeserializer");
    ...
    private static KafkaProducer<String, MessageDto> createKafkaProducer() {
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, "com.sriram.kafka.serdes.CustomSerializer");
