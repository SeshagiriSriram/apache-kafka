package com.sriram.kafka.message.ordering;

import com.sriram.kafka.message.ordering.payload.UserEvent;
import com.sriram.kafka.message.ordering.serialization.JacksonDeserializer;
import com.sriram.kafka.message.ordering.serialization.JacksonSerializer;
...
public class SinglePartitionLiveTest {
    ...
    @Container
    private static final KafkaContainer KAFKA_CONTAINER = new KafkaContainer(DockerImageName.parse("confluentinc/cp-kafka7.5.0"));
